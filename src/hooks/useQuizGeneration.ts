...
import { QuizGenerationRequest, QuizGenerationResponse, QuizOptions } from '@/lib/llm/types'

export interface UseQuizGenerationReturn {
  generateQuiz: (content: string, contentType: 'text' | 'pdf' | 'image', options?: QuizOptions) => Promise<QuizGenerationResponse>

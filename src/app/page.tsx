  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-blue-50 p-6">
      <div className="w-full max-w-xl rounded-2xl border bg-white shadow-sm p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-6 text-center">Welcome to Sahayak</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="rounded-lg border p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">Create rooms and invite students</p>
              ...
              <div className="rounded-lg border p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">Join your teacher's class</p>

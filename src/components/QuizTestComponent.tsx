  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Button onClick={refreshQuizzes}>Refresh</Button>
      </div>

      <div className="mb-4">
        <p className="text-sm text-gray-600">Found {quizzes.length} quiz(es)</p>
      </div>

      {quizzes.length === 0 ? (
        <div className="bg-gray-100 border border-gray-300 text-gray-700 px-4 py-3 rounded">
          <p>
            No quizzes found. Generate a quiz using the /quiz command to test
            the database!
          </p>
        </div>
      ) : (
